            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center mb-6">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800">Edit Informasi Kelas</h3>
                            <p class="text-sm text-gray-600 mt-1">Perbarui informasi kelas yang sudah ada</p>
                        </div>
                    </div>

                    <form method="post" action="{{ route('rombel.update', $rombel->id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
